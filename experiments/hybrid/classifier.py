...
class PatchShuffle(nn.Module):
    def __init__(self, freeze_backbone=True):
        ...
        self.orig_backbone = SiglipVisionModel.from_pretrained(MODEL_NAME)
        self.shuf_backbone = SiglipVisionModel.from_pretrained(MODEL_NAME)
        ...
        self.classifier = nn.Linear(self.feature_dim * 2, 1)

    def forward(self, img_orig, img_shuf):
        # Forward pass through SigLIP 2 vision towers; pooler_output yields the global image embedding vector [Batch, Hidden_Size]
